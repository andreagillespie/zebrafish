...
project directory: /dawson_genomics/Projects/zebrafish/SLAMSeq/220413_NB501056_0788_AH2VWYBGXM
...
for fq in /pipeline/Runs/NextSeq/220413_NB501056_0788_AH2VWYBGXM/ProjectFolders/Project_Vicky-Tan/*/[A-Z][0,S][1-4]_S[0-9][0-9]_R1_001.fastq.gz
do
...
project.dir <- "/dawson_genomics/Projects/zebrafish/SLAMSeq/220413_NB501056_0788_AH2VWYBGXM"
...
sample.ann <- data.frame(
  ...
  "treatment" = c(rep("UPRTneg", 4), rep("DMSO", 4), rep("MTZ", 4)),
...
writeLines(
  sesh.info,
  file.path(project.dir, "session-info", paste0(Sys.Date(), "_slamseq_220413.txt"))
)
```
